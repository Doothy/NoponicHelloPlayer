package gg.oddysian.death.helloplayer.helloplayer;

import gg.oddysian.death.helloplayer.helloplayer.listeners.LoginListener;
...
public class HelloPlayer {
     ...
     */
    @Mod.Instance(MOD_ID)
    public static HelloPlayer INSTANCE;
    ...
    public void preinit(FMLPreInitializationEvent event) {
        log.info("Death's Tippy Tappy " + MOD_NAME + " welcoming players, wow !");
